/**
 * @file <myepuck/simulator/myepuck_entity.h>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#ifndef MYEPUCK_ENTITY_H
#define MYEPUCK_ENTITY_H
...
namespace argos {
   ...
   class CMyEPuckEntity : public CComposableEntity {
   ...
   public:
      ...
      CMyEPuckEntity(const std::string& str_id,
