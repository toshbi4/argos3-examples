/**
 * @file <argos3/plugins/simulator/sensors/myepuck_proximity_default_sensor.h>
 *
 * @author Danesh Tarapore - <daneshtarapore@gmail.com>
 */

#ifndef MYEPUCK_PROXIMITY_DEFAULT_SENSOR_H
#define MYEPUCK_PROXIMITY_DEFAULT_SENSOR_H

#include <string>
#include <map>

namespace argos {
   class CMyEPuckProximityDefaultSensor;
   class CProximitySensorEquippedEntity;
}

#include <myepuck/control_interface/ci_myepuck_proximity_sensor.h>
...
namespace argos {
   ...
   class CMyEPuckProximityDefaultSensor : public CSimulatedSensor,
                                   public CCI_MyEPuckProximitySensor {

   public:

      CMyEPuckProximityDefaultSensor();

      virtual ~CMyEPuckProximityDefaultSensor() {}
