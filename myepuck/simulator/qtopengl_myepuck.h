/**
 * @file <myepuck/simulator/qtopengl_myepuck.h>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#ifndef QTOPENGL_MYEPUCK_H
#define QTOPENGL_MYEPUCK_H

namespace argos {
   class CQTOpenGLMyEPuck;
...
namespace argos {
   ...
   public:
      ...
      virtual ~CQTOpenGLMyEPuck();

      virtual void Draw(CMyEPuckEntity& c_entity);
