/**
 * @file <myepuck/simulator/dynamics3d_myepuck_model.cpp>
 *
 * @author Michael Allwright - <allsey87@gmail.com>
 */

#include "dynamics3d_myepuck_model.h"
...
namespace argos {
   ...
   CDynamics3DMyEPuckModel::CDynamics3DMyEPuckModel(CDynamics3DEngine& c_engine,
                                                CMyEPuckEntity& c_myepuck) :
      /* technically, the CDynamics3DMultiBodyObjectModel should be initialized with 7 children
         links, however, setting it to 7 makes the myepuck less stable for reasons. */
      CDynamics3DMultiBodyObjectModel(c_engine, c_myepuck, 3, false),
      m_cWheeledEntity(c_myepuck.GetWheeledEntity()) {
      ...
      const SAnchor& sOriginAnchor = c_myepuck.GetEmbodiedEntity().GetOriginAnchor();
      ...
      SAnchor* psBodyAnchor = &c_myepuck.GetEmbodiedEntity().AddAnchor("body", {0.0, 0.0, 0.00125});
      /* create the bodies */
   ...
   void CDynamics3DMyEPuckModel::Reset() {
   ...
   void CDynamics3DMyEPuckModel::CalculateBoundingBox() {
   ...
   void CDynamics3DMyEPuckModel::UpdateEntityStatus() {
   ...
   void CDynamics3DMyEPuckModel::UpdateFromEntityStatus() {
      /* run the base class's implementation of this method */
   ...
   void CDynamics3DMyEPuckModel::AddToWorld(btMultiBodyDynamicsWorld& c_world) {
      /* run the base class's implementation of this method */
   ...
   void CDynamics3DMyEPuckModel::RemoveFromWorld(btMultiBodyDynamicsWorld& c_world) {
   ...
   REGISTER_STANDARD_DYNAMICS3D_OPERATIONS_ON_ENTITY(CMyEPuckEntity, CDynamics3DMyEPuckModel);

   /****************************************/
   /****************************************/

   const btVector3    CDynamics3DMyEPuckModel::m_cBodyHalfExtents(0.0362, 0.0236, 0.0362);
   const btScalar     CDynamics3DMyEPuckModel::m_fBodyMass(0.242);
   const btTransform  CDynamics3DMyEPuckModel::m_cBodyOffset(btQuaternion(0.0, 0.0, 0.0, 1.0), btVector3(0.0,0.00125,0.0));
   const btTransform  CDynamics3DMyEPuckModel::m_cBodyGeometricOffset(btQuaternion(0.0, 0.0, 0.0, 1.0), btVector3(0.0, -0.0236, 0.0));
   const btVector3    CDynamics3DMyEPuckModel::m_cWheelHalfExtents(0.02125,0.0015,0.02125);
   const btScalar     CDynamics3DMyEPuckModel::m_fWheelMass(0.006);
   const btTransform  CDynamics3DMyEPuckModel::m_cWheelGeometricOffset(btQuaternion(0.0, 0.0, 0.0, 1.0), btVector3(0.0,-0.0015,0.0));
   const btTransform  CDynamics3DMyEPuckModel::m_cLeftWheelOffset(btQuaternion(btVector3(-1,0,0), SIMD_HALF_PI), btVector3(0.0, 0.02125, -0.0255));
   const btTransform  CDynamics3DMyEPuckModel::m_cRightWheelOffset(btQuaternion(btVector3(1,0,0), SIMD_HALF_PI), btVector3(0.0, 0.02125, 0.0255));
   const btVector3    CDynamics3DMyEPuckModel::m_cBodyToRightWheelJointOffset(0.0, -0.0036, 0.0255);
   const btVector3    CDynamics3DMyEPuckModel::m_cRightWheelToBodyJointOffset(0.0, 0.0015, 0.0);
   const btQuaternion CDynamics3DMyEPuckModel::m_cBodyToRightWheelJointRotation(btVector3(-1,0,0), SIMD_HALF_PI);
   const btVector3    CDynamics3DMyEPuckModel::m_cBodyToLeftWheelJointOffset(0.0, -0.0036, -0.0255);
   const btVector3    CDynamics3DMyEPuckModel::m_cLeftWheelToBodyJointOffset(0.0, 0.0015, -0.0);
   const btQuaternion CDynamics3DMyEPuckModel::m_cBodyToLeftWheelJointRotation(btVector3(1,0,0), SIMD_HALF_PI);
   /* TODO calibrate these values */
   const btScalar     CDynamics3DMyEPuckModel::m_fWheelMotorMaxImpulse(0.15);
   const btScalar     CDynamics3DMyEPuckModel::m_fWheelFriction(5.0);
