/**
 * @file <myepuck/simulator/myepuck_entity.cpp>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#include "myepuck_entity.h"
...
namespace argos {
   ...
   CMyEPuckEntity::CMyEPuckEntity(const std::string& str_id,
   ...
   void CMyEPuckEntity::Init(TConfigurationNode& t_tree) {
      try {
         /*
          * Init parent
          */
...
#define UPDATE(COMPONENT) if(COMPONENT->IsEnabled()) COMPONENT->Update();
   ...
   void CMyEPuckEntity::UpdateComponents() {
   ...
   REGISTER_ENTITY(CMyEPuckEntity,
                   "my_e-puck",
                   "Carlo Pinciroli [ilpincy@gmail.com]",
                   "1.0",
                   "The my_e-puck robot.",
                   "The my_e-puck is a open-hardware, extensible robot intended for education. In its\n"
                   ...
                   "red LEDs. More information is available at http://www.myepuck.org\n\n"
                   ...
                   "my_e-puck in the arena. When the robot is untranslated and unrotated, the\n"
                   ...
                   "The 'body/orientation' attribute specifies the orientation of the my_e-puck. All\n"
                   ...
                   "my_e-puck. The value of the attribute must be set to the id of a previously\n"
                   "defined controller. Controllers are defined in the <controllers> XML subtree.\n\n"
                   "OPTIONAL XML CONFIGURATION\n\n"
                   "You can set the emission range of the range-and-bearing system. By default, a\n"
                   "message sent by an my_e-puck can be received up to 80cm. By using the 'rab_range'\n"
                   "attribute, you can change it to, i.e., 4m as follows:\n\n"
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <my_e-puck id=\"eb0\" rab_range=\"4\">\n"
                   "      <body position=\"0.4,2.3,0.25\" orientation=\"45,90,0\" />\n"
                   "      <controller config=\"mycntrl\" />\n"
                   "    </my_e-puck>\n"
                   "    ...\n"
                   ...
                   "system. By default, a message sent by an my_e-puck is 2 bytes long. By using the\n"
                   "'rab_data_size' attribute, you can change it to, i.e., 20 bytes as follows:\n\n"
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <my_e-puck id=\"eb0\" rab_data_size=\"20\">\n"
                   "      <body position=\"0.4,2.3,0.25\" orientation=\"45,90,0\" />\n"
                   "      <controller config=\"mycntrl\" />\n"
                   "    </my_e-puck>\n"
                   "    ...\n"
   ...
   REGISTER_STANDARD_SPACE_OPERATIONS_ON_COMPOSABLE(CMyEPuckEntity);
