/**
 * @file <myepuck/simulator/qtopengl_myepuck.cpp>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#include "qtopengl_myepuck.h"
...
namespace argos {
   ...
   CQTOpenGLMyEPuck::CQTOpenGLMyEPuck() :
      m_unVertices(40),
   ...
   void CQTOpenGLMyEPuck::Draw(CMyEPuckEntity& c_entity) {
      /* Place the chassis */
   ...
   void CQTOpenGLMyEPuck::SetGreenPlasticMaterial() {
   ...
   void CQTOpenGLMyEPuck::SetRedPlasticMaterial() {
   ...
   void CQTOpenGLMyEPuck::SetCircuitBoardMaterial() {
   ...
   void CQTOpenGLMyEPuck::SetLEDMaterial(GLfloat f_red,
                                       GLfloat f_green,
                                       GLfloat f_blue) {
   ...
   void CQTOpenGLMyEPuck::RenderWheel() {
      /* Set material */
   ...
   void CQTOpenGLMyEPuck::RenderChassis() {
      /* Set material */
   ...
   void CQTOpenGLMyEPuck::RenderBody() {
      /* Set material */
      SetGreenPlasticMaterial();
   ...
   void CQTOpenGLMyEPuck::RenderLED() {
      /* Side surface */
      CVector2 cVertex(BODY_RADIUS, 0.0f);
      CRadians cAngle(CRadians::TWO_PI / m_unVertices);
      CVector2 cNormal(1.0f, 0.0f);
   ...
   class CQTOpenGLOperationDrawMyEPuckNormal : public CQTOpenGLOperationDrawNormal {
   public:
      void ApplyTo(CQTOpenGLWidget& c_visualization,
                   CMyEPuckEntity& c_entity) {
         static CQTOpenGLMyEPuck m_cModel;
   ...
   class CQTOpenGLOperationDrawMyEPuckSelected : public CQTOpenGLOperationDrawSelected {
   public:
      void ApplyTo(CQTOpenGLWidget& c_visualization,
                   CMyEPuckEntity& c_entity) {
   ...
   REGISTER_QTOPENGL_ENTITY_OPERATION(CQTOpenGLOperationDrawNormal, CQTOpenGLOperationDrawMyEPuckNormal, CMyEPuckEntity);

   REGISTER_QTOPENGL_ENTITY_OPERATION(CQTOpenGLOperationDrawSelected, CQTOpenGLOperationDrawMyEPuckSelected, CMyEPuckEntity);
