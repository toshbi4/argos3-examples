/**
 * @file <myepuck/simulator/dynamics3d_myepuck_model.h>
 *
 * @author Michael Allwright - <allsey87@gmail.com>
 */

#ifndef DYNAMICS3D_MYEPUCK_MODEL_H
#define DYNAMICS3D_MYEPUCK_MODEL_H

namespace argos {
   class CDynamics3DMyEPuckModel;
   class CMyEPuckEntity;
...
namespace argos {
   ...
   class CDynamics3DMyEPuckModel : public CDynamics3DMultiBodyObjectModel {

   public:     

      CDynamics3DMyEPuckModel(CDynamics3DEngine& c_engine,
                            CMyEPuckEntity& c_myepuck);

      virtual ~CDynamics3DMyEPuckModel() {}
